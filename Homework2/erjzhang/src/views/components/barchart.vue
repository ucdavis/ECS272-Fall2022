...
export default {
    ...
    mounted() {
        ...
        this.drawBarChart(this.myBarchartData, "#bar", this.curr_year, this.x_key, this.top_n) /* Example of reading data from a json file */
    ...
    updated() {
        ...
        this.updateBarChart(this.myBarchartData, "#bar", this.curr_year, this.x_key, this.top_n)
    },
    methods: {
        updateBarChart(data, id, year, x_key, top_n) {
            ...
            data.forEach(country => {
                if (country[x_key].split(' ').length > 2) {
                    country[x_key] = country["country_code"]
                }
            });
