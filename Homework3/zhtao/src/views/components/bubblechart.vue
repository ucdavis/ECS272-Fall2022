<template>
    <div id="bubble">
        ...
        <div class="bubbleTitle">{{ year }} CO2 emission by country (Zoom)</div>
        <a-dropdown>
            <template #overlay>
          ...
          background-color: black`
            ...
            if (L) {
                ...
                leaf.append('text')
                    ...
                    .attr('color', 'black')
                    .text((d, i, D) => (d < 1 ? '' : d))
                    // .attr('font-size', (d) => !isNaN(d) && d > 1 ? 8 : 0 )
            }
            ...
            const legendLabel = d3
                ...
                .append('svg')
                .attr('width', width)
                .attr('viewBox', [-marginLeft, -marginTop, width, 40])
                .attr(
                    'style',
                    'max-width: 100%; height: auto; height: intrinsic;'
                );
            ...
            function zoomed({ transform }) {
                ...
                leaf.attr('transform', (d) => `translate(${d.x*transform.k},${d.y*transform.k}) ${transform}`);
            }
