...
var margin = { top: 120, right: 140, bottom: 165, left: 100 },
...
export default {
  ...
  mounted() {
    ...
    console.log(this.RadartestData, this.resetclick);
    ...
    this.drawRadarChart("#radar", labels, localData, options, this.resetclick);
  },
  watch: {
    RadartestData() {
      switch (this.RadartestData) {
    ...
    resetclick() {
      ...
      if(this.resetclick > 0) {
        this.drawRadarChart("#radar", labels, localData, options, this.resetclick);
      }
    },
  },
  methods: {
    drawRadarChart(id, labels, data, options, reset) {
      var cfg = {
      ...
      blobWrapper
        ...
        .on("click", function(d) {
          d3.select(this).transition().duration(200).remove()
        });
