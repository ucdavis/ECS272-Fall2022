        ...
        methods: {
            ...
            drawNetwork(nodes, links, id, selection) {
                ...
                svg.append("line")
                    ...
                    .attr('stroke-linecap', 'round')
                    .attr('x1', -width/2 + 10)
                    .attr('y1', -height/2 + 333-10)
                    .attr('x2', -width/2 + 10)
                    .attr('y2', -height/2 + 317-10)
                svg.append("line")
                    .attr('stroke', '#999')
                    .attr('stroke-width', 6)
                    .attr('stroke-opacity', 0.6)
                    .attr('stroke-linecap', 'round')
                    .attr('x1', -width/2 + 18)
                    .attr('y1', -height/2 + 332-10)
                    .attr('x2', -width/2 + 18)
                    .attr('y2', -height/2 + 318-10)
                svg.append("line")
                    .attr('stroke', '#999')
                    ...
                    .attr('stroke-linecap', 'round')
                    .attr('x1', -width/2 + 29)
                    .attr('y1', -height/2 + 330.5-10)
                    .attr('x2', -width/2 + 29)
                    .attr('y2', -height/2 + 319.5-10)
                svg.append("text")
                    .attr("x", -width/2 + 35)
                    .attr("y", -height/2 + 325-10)
                    .text("#Collaborated Song with Center (from low to high)")
                    .style("font-size", "12px")
                    .attr("alignment-baseline","middle")
                
                svg.append("circle")
                    .attr("cx", -width/2 + 2)
                    .attr("cy", -height/2 + 340)
                    .attr("r", 3)
                    .style("fill", color(6))
                svg.append("circle")
                    .attr("cx", -width/2 + 11)
                ...
                svg.append("text")
                    .attr("x", -width/2 + 35)
                    .attr("y", -height/2 + 340)
                    .text("#Total Collaborated Song (from low to high)")
                    .style("font-size", "12px")
                    .attr("alignment-baseline","middle")
