    ...
    <div class="dashboardContainer">
        <div class="row">
            <div class="column">
                ...
                <MapChart v-if="dataExistsMap" :myMapChartData="myMapData" @clicked="getMapCountry"/>
            </div>
            <div class="column">
                <div class="half-row">
                    <h1 class="focusviewTitle">CO2 Emission Changes In Years By Countries</h1>
                    <LineChart ref="myLineChart" v-if="dataExistsLine" :myLineChartData="myLineData" :selected_country="mapCountryData"/>
                </div>
                <div class="half-row">
...
export default {
    ...
    methods: {
        getMapCountry(value){
            console.log("Selected country ", value.country_name);
            this.mapCountryData = value.country_name;
            // this.$refs["myLineChart"].drawLine();
        },
        drawMapFromCsv(){
            //async method
