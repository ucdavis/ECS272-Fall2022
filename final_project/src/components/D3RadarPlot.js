        ...
        var color = d3.scaleOrdinal()
            ...
            var radarChartOptions2 = {
                ...
                color: d3.scaleOrdinal().range(["#AFC52F", "#ff6600", "#2a2fd4"]),
                  format: '.0f',
                  legend: { title: 'Countries', translateX: 100, translateY: 40 },
                  unit: ''
              };
        //Call function to draw the Radar chart
        this.RadarChart(this.myReference.current, this.props.data, radarChartOptions2, this.props.writeValue);

  
  }

RadarChart(parent_selector, data, options, writeValue) {
    const max = Math.max;
    const sin = Math.sin;
    const cos = Math.cos;
	...
	blobCircleWrapper.selectAll(".radarInvisibleCircle")
		...
		.on("click", function(d, i) {
			writeValue(d.target.__data__.axis);
		  });
